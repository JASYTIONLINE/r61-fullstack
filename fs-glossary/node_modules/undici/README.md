...
See [Dispatcher.pipeline](jasytionline.github.io/contents/20-portals/10-fs/glossary/node_modules/undici/docs/docs/api/Dispatcher.md#dispatcherpipelineoptions-handler) for more details.
